...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col-reverse items-start justify-start w-full min-h-screen bg-black lg:flex-row">
      {/* Form Section */}
      <div className="w-full lg:w-[60%] flex flex-col items-start justify-start p-5">
        ...
        >
          ...
          <div className="flex flex-col items-start w-full gap-3 mt-5 sm:flex-row sm:items-center">
            <label className="text-[#63ad58] text-[18px] font-bold w-[75px]">
              Name
            </label>
            <input
              type="text"
              ...
              value={name}
              onChange={nameChange}
              className="bg-transparent text-white border-2 border-[#63ad58] rounded-md w-full sm:w-[300px] py-2 px-3 outline-none"
            />
          </div>
          {errorName && (
          ...
          <div className="flex flex-col items-start w-full gap-3 mt-5 sm:flex-row sm:items-center">
            ...
            <input
              ...
              className="bg-transparent border-2 border-[#63ad58] text-white rounded-md w-full sm:w-[300px] py-2 px-3 outline-none"
            />
          </div>
          {errorEmail && (
            <p className="text-red-600 text-[14px] mt-1 sm:ml-[90px]">
          ...
          <div className="flex flex-col items-start w-full gap-3 mt-5 sm:flex-row sm:items-start">
            ...
            <textarea
              ...
              className="bg-transparent border-2 border-[#63ad58] rounded-md w-full sm:w-[300px] py-2 px-3 outline-none text-white"
            />
          </div>
          {errorMessage && (
            <p className="text-red-600 text-[14px] mt-1 sm:ml-[90px]">
          ...
          <button
            type="submit"
            className="mt-5 rounded-md font-semibold text-white bg-[#63ad58] px-6 py-2 self-center sm:self-start sm:ml-[90px]"
          >
            Submit
          </button>
        </form>
      ...
      {/* Question Section */}
      <div className="w-full lg:w-[40%] flex flex-col items-start justify-start border-b-2 lg:border-b-0 lg:border-l-2 border-[#63ad58] p-5">
        <h1 className="text-[26px] sm:text-[30px] text-[#63ad58] font-bold mb-3">
          Question
        </h1>
        <div className="w-full max-w-2xl">
          <h1 className="mb-4 text-xl font-bold text-white">Contact Form</h1>
          ...
          <div className="mb-4">
            <h3 className="font-semibold text-white">1. Form Structure:</h3>
          ...
          <div className="mb-4">
            <h3 className="font-semibold text-white">2. Form Submission:</h3>
            <ul className="text-white list-disc list-inside">
          ...
          <div className="mb-4">
            <h3 className="font-semibold text-white">3. Form Validation:</h3>
            <ul className="text-white list-disc list-inside">
          ...
          <div>
            <h3 className="font-semibold text-white">4. Display Submitted Data:</h3>
            <ul className="text-white list-disc list-inside">
